...
export const venueOccasions: OccasionItem[] = [
  {
    ...
    imageAlt: "Illuminated purple and gold royal floral tunnel walkway with cascading wisteria blossoms and red damask carpet at Shahi Junction Villa",
  },
  {
    id: "engagements",
  ...
  },
  {
    ...
    image: shahiParking,
    imageAlt: "Spacious landscaped car parking lot filled with hundreds of guest vehicles at Shahi Junction Villa in Punjab",
  },
  {
    ...
    imageAlt: "Daytime architectural facade of Shahi Junction Villa for milestone family celebrations",
  },
];
...
export const galleryPhotos: GalleryPhoto[] = [
  {
    ...
    alt: "Daytime facade view of Shahi Junction Villa showing the grand white neoclassical colonnade, carved entrance signage, and dome finials in Punjab",
    aspect: "landscape",
    focusPosition: "center 50%",
    tagline: "Authentic Neoclassical architecture with carved Shahi Junction Villa entrance",
  },
  {
    src: palaceGate,
    title: "Ceremonial Palace Entrance Gate",
    category: "Palace Architecture",
    alt: "Grand entrance portico with white Corinthian columns, hanging chandelier, and cascading marigold flower staircase at Shahi Junction Villa",
    aspect: "portrait",
    focusPosition: "center 55%",
  ...
  },
  {
    ...
    alt: "Opulent indoor banquet hall at Shahi Junction Villa with multi-tier cove lighting, classical white pillars, floral carpet, and royal navy blue velvet dining chairs",
    aspect: "portrait",
    focusPosition: "center 50%",
  ...
  },
  {
    ...
    alt: "Illuminated multi-foil white lattice jali arch gateway framed with fresh roses, candlelit niches, and hanging wisteria walkway at Shahi Junction Villa",
    aspect: "portrait",
    focusPosition: "center 45%",
  ...
  },
  {
    ...
    alt: "Luxury VIP lounge seating at Shahi Junction Villa with plush magenta leather couches, draped silk canopies, and lush hanging greenery",
    aspect: "portrait",
    focusPosition: "center 50%",
  ...
  },
  {
    ...
    alt: "Spacious landscaped car parking lot at Shahi Junction Villa filled with guest vehicles under clear blue skies with palm trees",
    aspect: "landscape",
    focusPosition: "center 50%",
  ...
  },
  {
    ...
    category: "Barat & Jaimala",
    alt: "Illuminated bridal and barat floral walkway with purple and gold draped ceiling, hanging wisteria arches, and red patterned carpet runner at Shahi Junction Villa",
    aspect: "portrait",
    focusPosition: "center 50%",
  ...
  },
  {
    ...
    alt: "Modern bar counter with wooden pergola canopy, illuminated Kingfisher neon, draft beer dispenser towers, and back-lit cocktail glassware at Shahi Junction Villa",
    aspect: "portrait",
    focusPosition: "center 50%",
  ...
  },
  {
    ...
    category: "Restaurant & Bar",
    alt: "Air-conditioned indoor dining hall with circular cove ceiling, warm downlights, and red velvet booth seating at Shahi Junction Villa",
    aspect: "portrait",
    focusPosition: "center 50%",
